export const BULLET_SPEED_IN_SECOND = 600;
export const BULLET_ROAD_SIZE = 50;
...
export const P1_DOWN_KEY_CODE = 83;
export const P1_P2_LEFT_KEY_CODE = 65;
export const P1_ROTATE_P2_LEFT_KEY_CODE = 70;
export const P1_ROTATE_RIGHT_KEY_CODE = 72;
export const P1_BULLET_FIRE_KEY_CODE = 71;

// player 2
export const P2_LEFT_KEY_CODE = 37;
